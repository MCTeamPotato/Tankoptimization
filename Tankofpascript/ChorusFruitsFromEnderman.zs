//这个脚本让末影人有80%的概率掉落一个紫颂果。
//This script gives enderman 80% chance of dropping an Chorus Fruit.
//推荐配合更好的末地：土豆版食用，这样你就不怕找不到紫颂果。
//It's recommended to use this with Better End Potato Edition so you won't go crazy about looking for Chours Fruits.
//Q：为什么不是百分百？
//Q: Why is the probability not 100%?
//A：因为爱情。
//A: Because of love.
//Q：为什么不把这个设定写进 Better End Potato Edition 模组本体里呢？
//Q: Why not include this setting in the Better End Potato Edition mod?
